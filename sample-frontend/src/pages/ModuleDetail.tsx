...
const ModuleDetail = () => {
  ...
  useEffect(() => {
    const loadModuleContent = async () => {
      ...
      // Simulate loading delay (3-5 seconds)
        ...
        <div className="flex items-center justify-center h-64">
          ...
          >
            <motion.div
              ...
              className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center"
            >
              <BookOpen className="w-8 h-8 text-primary-foreground" />
            </motion.div>
            <div>
              <p className="text-lg font-semibold text-foreground">Loading module content...</p>
              <p className="text-sm text-muted-foreground mt-1">
                {moduleId && `Preparing ${decodeURIComponent(moduleId)}`}
              </p>
            </div>
