...
const Onboarding = () => {
  ...
  const [generatingModule, setGeneratingModule] = useState<{ number: number; name: string } | null>(null);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const roadmap = await generateRoadmap(profile, (moduleNumber, moduleName) => {
        setGeneratingModule({ number: moduleNumber, name: moduleName });
      });
